...
#ifndef CUSTOM_INTERFACES__MSG__DETAIL__RGB__TRAITS_HPP_
#define CUSTOM_INTERFACES__MSG__DETAIL__RGB__TRAITS_HPP_
...
inline void to_yaml(
  const custom_interfaces::msg::RGB & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const custom_interfaces::msg::RGB & msg)
{
  return custom_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<custom_interfaces::msg::RGB>()
{
  return "custom_interfaces::msg::RGB";
}

template<>
inline const char * name<custom_interfaces::msg::RGB>()
{
  return "custom_interfaces/msg/RGB";
}

template<>
struct has_fixed_size<custom_interfaces::msg::RGB>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<custom_interfaces::msg::RGB>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<custom_interfaces::msg::RGB>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // CUSTOM_INTERFACES__MSG__DETAIL__RGB__TRAITS_HPP_
